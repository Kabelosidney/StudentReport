    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent kb = new Intent(TeachersSignupActivity.this,TeachersLoggin.class);
                startActivity(kb);
            }
        });
            ...
            public void onClick(View view) {
                if (view.getId() == R.id.signUpBtn)
                {
                    ...
                    if (!passwordstr.equals(confirmstr))
                    {
                        ...
                        Toast.makeText(TeachersSignupActivity.this, "Passwords do not match", Toast.LENGTH_SHORT).show();
                    }
                    if (passwordstr.equals(confirmstr))
                    {
                        Intent kb = new Intent(TeachersSignupActivity.this, TeachersLoggin.class);
                        ...
                        Toast.makeText(TeachersSignupActivity.this, "Successfully Registered", Toast.LENGTH_SHORT).show();
